...
pub enum AutomationCommand {
    ...
    KeyboardKey { key: String, modifiers: Vec<KeyModifier> },
    KeyboardHotkey { keys: Vec<String> },
    ClipboardSet { content: String, content_type: Option<String> },
    AppLaunch { executable: String, args: Vec<String>, working_dir: Option<String> },
    WindowFocus { window_id: u64 },
    WindowMove { window_id: u64, x: i32, y: i32 },
    WindowResize { window_id: u64, width: u32, height: u32 },
    WindowMinimize { window_id: u64 },
    WindowMaximize { window_id: u64 },
    WindowRestore { window_id: u64 },
